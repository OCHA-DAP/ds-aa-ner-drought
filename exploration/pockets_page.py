...
def main():
    ...
    img_rain = figs.fig_rain_rp_pair(summary)
    ...
    flag = summary[
        (
            summary[["chirps_rp", "imerg_rp", "seas5_jas_rp", "veg_rp"]] >= 5
        ).any(axis=1)
...
<p>{T(
    ...
    "2026 season, by putting this year's observed rainfall (satellite products "
    "and rain gauges), vegetation stress (FAO ASI and the NDVI-based VHI) and "
    ...
    "observées cette année (produits satellitaires et pluviomètres), le "
...
<li>{T(
  "The most consistent pockets (3 of 4 indicators at RP ≥ 5): most of Dosso "
  "region (Dosso, Loga, Tibiri, Dioundiou, Dogondoutchi, Gaya), the Tahoua "
  "belt (Illéla, Keita, Ville de Tahoua, Bouza, Bagaroua) and Filingué "
  "(Tillabéri). A second, needs-critical pocket covers eastern Diffa "
  "(N'Guigmi, Bosso, Diffa) and western Tillabéri (Téra, Bankilaré, "
  "Torodi, Ayerou), driven by IMERG June–August deficits and the dry "
  "end-of-season outlook.",
  "Les poches les plus cohérentes (3 indicateurs sur 4 à PR ≥ 5)&nbsp;: "
  "l’essentiel de la région de Dosso (Dosso, Loga, Tibiri, Dioundiou, "
  "Dogondoutchi, Gaya), la bande de Tahoua (Illéla, Keita, Ville de "
  "Tahoua, Bouza, Bagaroua) et Filingué (Tillabéri). Une seconde poche, "
  "critique du point de vue des besoins, couvre l’est de Diffa (N'Guigmi, "
  "Bosso, Diffa) et l’ouest de Tillabéri (Téra, Bankilaré, Torodi, "
  "Ayerou), portée par les déficits IMERG de juin–août et la perspective "
  "sèche de fin de saison.")}</li>
<li>{T(
...
<li>{T(
  "The August-issued SEAS5 outlook, blended with July observations "
  "(in-season JAS composite), points to a dry end of season over the west "
  "and south — Dosso, Tillabéri and Niamey are at RP ≥ 9 with high model "
  "performance (r ≥ 0.65).",
  "La prévision SEAS5 émise en août, combinée aux observations de juillet "
  "(composite JAS en cours de saison), indique une fin de saison sèche sur "
  "l’ouest et le sud — Dosso, Tillabéri et Niamey sont à PR ≥ 9 avec une "
  "performance élevée du modèle (r ≥ 0,65).")}</li>
<li>{T(
...
<p>{T(
  "The map counts how many of four indicators are at a ≥ 5-year return "
  "period in each department: CHIRPS June–July rainfall, IMERG June–August "
  "rainfall, the skill-filtered SEAS5 in-season JAS outlook, and regional "
  "vegetation (worst of ASI / VHI). The indicators are related but not "
  "redundant — the two rainfall products use different sensors and windows "
  "and disagree regionally in 2026. Hatching marks the four departments in "
  "HNRP severity class 4.",
  "La carte compte, pour chaque département, combien de quatre indicateurs "
  "sont à une période de retour ≥ 5&nbsp;ans&nbsp;: précipitations CHIRPS "
  "juin–juillet, précipitations IMERG juin–août, perspective SEAS5 JAS en "
  "cours de saison filtrée selon la performance, et végétation régionale "
  "(pire de l’ASI / du VHI). Les indicateurs sont liés mais non "
  "redondants — les deux produits pluviométriques reposent sur des "
  "capteurs et des fenêtres différents et divergent régionalement en "
  "2026. Les hachures marquent les quatre départements en classe de "
  "sévérité 4 du HNRP.")}</p>
<figure>
<img src="data:image/png;base64,{img_conv}" alt="Convergence map">
<figcaption>{T(
  "Number of indicators (0–4) at return period ≥ 5 years, by department; "
  "hatched: HNRP 2026 intersectoral severity 4.",
  "Nombre d’indicateurs (0–4) à une période de retour ≥ 5 ans, par "
...
<p class="note">{T(
  ...
  "value is shown for each department. SEAS5 RP is blank where the model has "
  "insufficient historical performance (r < 0.30).",
  ...
  "département. La PR SEAS5 est vide lorsque la performance historique du "
  "modèle est insuffisante (r &lt; 0,30).")}</p>

<h2>{T("Observed rainfall — satellite products",
       "Précipitations observées — produits satellitaires")}</h2>
<p>{T(
  "CHIRPS (gauge-calibrated, 1981–2026, final product available through "
  "July) and IMERG (satellite-only, 1998–2026, available through 30 August) "
  "give two independent views of the season. Both agree on the Tahoua–Dosso "
  "belt and eastern Diffa; IMERG, which sees August, adds western Tillabéri. "
  "Where they disagree (CHIRPS drier in Tahoua/Dosso, IMERG drier in "
  "Diffa/Tillabéri), both are shown rather than averaged.",
  "CHIRPS (calé sur les pluviomètres, 1981–2026, produit final disponible "
  "jusqu’à juillet) et IMERG (satellitaire, 1998–2026, disponible jusqu’au "
  "30 août) offrent deux regards indépendants sur la saison. Les deux "
  "concordent sur la bande Tahoua–Dosso et l’est de Diffa&nbsp;; IMERG, qui "
  "couvre août, ajoute l’ouest de Tillabéri. Là où ils divergent (CHIRPS "
  "plus sec sur Tahoua/Dosso, IMERG plus sec sur Diffa/Tillabéri), les deux "
  "sont montrés plutôt que moyennés.")}</p>
<p class="note">{T(
...
<figcaption>{T(
  "Return period of the 2026 seasonal rainfall total per department "
  "(rank of 2026 within the full record, Weibull (n+1)/rank). Left: CHIRPS "
  "June–July (46 years). Right: IMERG 1 June – 30 August (29 years).",
  "Période de retour du cumul saisonnier 2026 par département (rang de 2026 "
  "dans l’historique complet, Weibull (n+1)/rang). Gauche&nbsp;: CHIRPS "
  "juin–juillet (46&nbsp;ans). Droite&nbsp;: IMERG 1ᵉʳ juin – 30 août "
  "(29&nbsp;ans).")}</figcaption>
</figure>
...
<h2>{T("SEAS5 seasonal forecast, skill-filtered",
       "Prévision saisonnière SEAS5, filtrée selon la performance")}</h2>
<p>{T(
  "Following the team's SEAS5 skill methodology, the August-issued ECMWF "
  "SEAS5 forecast is normalized against ERA5 per department, and only shown "
  "where the model's historical performance is adequate (Pearson r ≥ 0.30 "
  "over 45 hindcast years; hatched/blank otherwise). The JAS panel is an "
  "in-season composite — July comes from ERA5 observations, August and "
  "September from the current forecast — so it reads as confidence about "
  "how the season will end, and its historical performance is naturally "
  "high (r 0.65–0.85 across Niger). ASO is a pure forecast for the end of "
  "the season.",
  "Suivant la méthodologie d’évaluation de SEAS5 de l’équipe, la prévision "
  "SEAS5 (CEPMMT) émise en août est normalisée par rapport à ERA5 pour "
  "chaque département, et n’est montrée que là où la performance "
  "historique du modèle est suffisante (r de Pearson ≥ 0,30 sur 45 années "
  "de re-prévisions&nbsp;; hachuré/vide sinon). Le panneau JAS est un "
  "composite en cours de saison — juillet provient des observations ERA5, "
  "août et septembre de la prévision actuelle — il se lit donc comme un "
  "niveau de confiance sur la fin de saison, et sa performance historique "
  "est naturellement élevée (r de 0,65 à 0,85 sur le Niger). ASO est une "
  "prévision pure pour la fin de saison.")}</p>
<figure>
<img src="data:image/png;base64,{img_seas5}" alt="SEAS5 return period maps">
<figcaption>{T(
  "Return period of the 2026 forecast within the 1981–2025 hindcast "
  "distribution (dry tail), issued August 2026. Left: JAS in-season "
  "composite. Right: ASO forecast.",
  "Période de retour de la prévision 2026 dans la distribution des "
  "re-prévisions 1981–2025 (queue sèche), émission d’août 2026. "
  "Gauche&nbsp;: composite JAS en cours de saison. Droite&nbsp;: prévision "
  "ASO.")}</figcaption>
</figure>
...
<li>{T(
  ...
  "CHIRPS v2.0 Afrique mensuel (CHC, final jusqu’à juillet 2026)&nbsp;; "
