...
<figcaption>{T(
  ...
  "median rainfall RP 5–10 / ≥ 10 years; dark-red hatching: vegetation "
  ...
  "ans&nbsp;; hachures rouge foncé&nbsp;: pilier végétation (VHI "
  "détendancé) à PR 5–10 (diagonales) ou ≥ 10 (croisées) — des "
...
<figcaption>{T(
  ...
  "regional VHI, late-August dekad) sits at RP ≥ 5 (dark: ≥ 10). The "
  "marker strip flags the CERF drought seasons (red squares; the 2022 "
  "AA activation grey) and EM-DAT drought events since 2000 (black "
  "diamonds), each attributed to the growing season inside its window "
  "that the framework's severity list ranks worst. 2026's rainfall count is the largest since 2009–2011; its "
  ...
  "régional détendancé, décade fin août) est à PR ≥ 5 (foncé&nbsp;: "
  "≥ 10). Le bandeau de repères signale les saisons de sécheresse CERF "
  "(carrés rouges&nbsp;; l'activation AA de 2022 en gris) et les "
  "événements de sécheresse EM-DAT depuis 2000 (losanges noirs), "
  "chacun rattaché à la saison agricole de sa fenêtre que la liste de "
  "sévérité du cadre classe la pire. Le "
...
<p>{T(
  ...
  "per DMN's own coding against its 30-year normals (Gouré, Dosso and "
  "Maradi in "
  ...
  "normales trentenaires (Gouré, Dosso et Maradi dans le deuxième), et "
...
<p>{T(
  ...
  "warnings on 29 of Niger's 35 assessed units (cropland and/or "
  "rangeland), with the Dosso–Tahoua–"
  ...
  "et affine — le tableau&nbsp;: alertes sur 29 des 35 unités évaluées "
  "du Niger (cultures et/ou pâturages), la bande Dosso–Tahoua–Tillabéri "
  "en niveau 1/1+, et "
